...
//        validador.validaNulleVazio(idObjetivo, "Campo idObjetivo nao pode ser nulo ou vazio.");
//
//        return controllerPesquisa.desassociaObjetivo(idPesquisa, controllerObjetivo.getObjetivo(idObjetivo));
//
//    }
//
//    /**
...
//
//        return controllerPesquisa.associaAtividade(codigoPesquisa, controllerAtividade.getAtividade(codigoAtividade));
//    }
//
...
//        validador.validaNulleVazio(codigoAtividade, "Campo codigoAtividade nao pode ser nulo ou vazio.");
//
//        return controllerPesquisa.desassociaAtividade(codigoPesquisa, controllerAtividade.getAtividade(codigoAtividade));
//    }
//
}
